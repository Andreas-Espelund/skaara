<template>
    ...
    >
        ...
        <a
            ...
            target="_blank"
            class="text-primary border-primary border-2 hover:bg-primary/20 font-medium p-3 md:p-4 md:px-8 text-center rounded-full text-sm md:text-xl h-min transition-all"
        >
            Buy a gift card
        </a>
    </div>
